...
/// <summary>
/// Command for moving the player left in the CSV mini-game.
/// </summary>
public class CsvMoveLeft : ICommand
{
    /// <summary>
    /// Executes the command to move the player left in the CSV mini-game.
    /// </summary>
